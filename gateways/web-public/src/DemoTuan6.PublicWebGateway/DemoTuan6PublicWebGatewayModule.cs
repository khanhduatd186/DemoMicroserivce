...
using DemoTuan6.Shared.Hosting.Gateways;
using Swashbuckle.AspNetCore.SwaggerUI;
using Volo.Abp;
using Volo.Abp.Modularity;
using Yarp.ReverseProxy.Configuration;

namespace DemoTuan6.PublicWebGateway;

[DependsOn(
    typeof(DemoTuan6SharedHostingGatewaysModule)
)]
public class DemoTuan6PublicWebGatewayModule : AbpModule
{
