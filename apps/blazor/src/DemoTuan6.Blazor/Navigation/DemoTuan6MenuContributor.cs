...
namespace DemoTuan6.Blazor.Navigation;

public class DemoTuan6MenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public DemoTuan6MenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<DemoTuan6Resource>();
