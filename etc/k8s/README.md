...
Necessary helm charts are created under `etc/k8s/demotuan6` folder. Based on your back-office application UI, remove the other UI charts. Ex, if you are using **angular** UI, remove **web**, **blazor** and **blazor-server** charts.
...
````powershell
127.0.0.1 blazor.demotuan6.dev
127.0.0.1 demotuan6.dev
127.0.0.1 authserver.demotuan6.dev
127.0.0.1 identity.demotuan6.dev
127.0.0.1 administration.demotuan6.dev
127.0.0.1 product.demotuan6.dev
127.0.0.1 saas.demotuan6.dev
127.0.0.1 gateway-web.demotuan6.dev
127.0.0.1 gateway-public.demotuan6.dev
````
...
* Run `deploy-staging.ps1` in the `helm-chart` directory. It is deployed with the `demotuan6` namespace.

* *You may wait ~30 seconds on first run for preparing the database*.

* Browse https://demotuan6-st-public-web for public and
   https://demotuan6-st-blazor for the back-office application
